...
parser.add_argument('--num_epochs', dest='num_epochs', type=int, default=300, help='num_epochs')
...
save_dir = "/database/iyj0121/ckpt/rvidnet/finetuning_CRVD_rggb_baseline_texture_loss/" #_clean_and_slightly_denoised_gt
...
log_dir = "/database/iyj0121/ckpt/finetuning_CRVD_rggb_baseline/"
...
if initial_epoch > 0:
    ...
    denoiser = torch.load(os.path.join("/database/iyj0121/result/tcsvt/pretrain_CRVD_rggb_baseline/model_epoch33.pth")).cuda()
