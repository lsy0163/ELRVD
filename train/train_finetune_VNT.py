...
save_dir = "/database/iyj0121/ckpt/rvidenet/finetune_scene1_9_predenoising_unet_isp_true_rvidenet_pretrain_mot_only_gain_29p4_ft_vnt_video_lr_1e5_scratch/"
...
log_dir = "/database/iyj0121/tensorboard/finetune_scene1_9_predenoising_unet_isp_true_rvidenet_pretrain_mot_only_gain_29p4_ft_vnt_video_lr_1e5_scratch/"
...
if initial_epoch > 0:
    ...
    #denoiser = torch.load(os.path.join("/database/iyj0121/dataset/SRVD_data/pretrain_signal_independent_dependent_neif_noise_estimation_gain_only_29p4_final_mot_dataset/model_epoch33.pth")).cuda()
...
#opt = optim.Adam(denoiser.parameters(), lr=1e-4)  
...
for epoch in range(initial_epoch, args.num_epochs+1):
    ...
    for batch_id in range(int(train_data_length/batch_size)):
        ...
        while batch_num<batch_size:
            ...
            frame_ind = np.random.randint(2,198+1)
            ...
            for shift in range(-1,2):
                ...
                gt_raw_path = f'/database/iyj0121/dataset/vnt_pseudo_gt/SASSID_raw0317_120000iter_vbm3d_alpha0p3_out/scene_1_frame_{frame_idx:05d}.raw'
                ...
                noisy_raw_path = f'/database/iyj0121/dataset/hanhwa/raw_0317/dump_frame_1920x1080x6__{(frame_idx):03d}.raw'
